...
/*   Updated: 2023/03/04 17:18:29 by jincpark         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		t_raycast_param *raycast_param)
{
	...
	raycast_param->sprite.pos_x = (double)map_data->enemy_spawn[SPAWN_X] + 0.5;
	raycast_param->sprite.pos_y = (double)map_data->enemy_spawn[SPAWN_Y] + 0.5;
